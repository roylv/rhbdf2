...
pdf("~/public_html/rhbdf/sampMrg7.pdf")
...
for (i in sq){
	...
	if (j==1) {strt=0.3; endd=0.2}
	if (j==2) {strt=0.3; endd=0.9}
	if (j==3) {strt=1.25; endd=-0.03}
	else {endd=0; strt=0}
...
#       points(mrg$bp[spidx][ind]/1e6, mrg$logP.merge[spidx][ind], pch=18, col=colMul)
        ...
        lines(keep.recomb[,2]/1e6,  keep.recomb[,3]*fac, type="l", col=colRec, lwd=1.8)
	...
	if (i==8) {
        rect(116598165/1e6,0.5,116627019/1e6,1.5, col="orange", border="orange", bty="n")#chd2
        rect(116537740/1e6,0.5,116581447/1e6,1.5, col="#660066", border="#660066", bty="n")#chd2
...
#	legend("topright", horiz=T, bty="n", legend=c("MA", "BA","Rhdf2"), col=c(colMul, colMrg, "orange"), pch=c(18,1,15), cex=0.87, bg="white")
	 legend("topright", horiz=T, bty="n",  legend=c("Rhdf2", "Ube2o", "Srsf2", "St6galnac2" ), col=c("orange", "#996633", "#FF6666", "#FF0000"), pch=c(15,15, 15, 15), cex=0.77, bg="white", box.col="white", adj=c(-1,0))
...
#       abline(v=116598165/1e6, lwd=0.1, color="lightgray"); abline(v=116627019/1e6, lwd=0.1, color="lightgray")
#       legend("topright", horiz=T, bty="n", legend=c("MA", "BA","Rhdf2"), col=c(colMul, colMrg, "orange"), pch=c(18,1,15), cex=0.87, bg="white")
         legend("topright", horiz=T, bty="n", legend=c("Rhdf2", "Ube2o", "Srsf2", "St6galnac2" ), col=c("orange", "#996633", "#FF6666", "#FF0000"), pch=c(15,15, 15, 15), cex=0.77, bg="white", box.col="white")
...
#       abline(v=116598165/1e6, lwd=0.1, color="lightgray"); abline(v=116627019/1e6, lwd=0.1, color="lightgray")
#       legend("topright", horiz=T, bty="n", legend=c("MA", "BA","Rhdf2"), col=c(colMul, colMrg, "orange"), pch=c(18,1,15), cex=0.87, bg="white")
         legend("topright", horiz=T, bty="n", legend=c("Klf17", "Kdm4a" ), col=c("orange", "#996633"), pch=c(15,15), cex=0.77, bg="white", box.col="white")
	...
	title(main="D", adj=0)
        ...
        rect(9844372/1e6,0.5,9862345/1e6,1.5, col="#660066", border="#660066", bty="n")#chd2
...
#       abline(v=116598165/1e6, lwd=0.1, color="lightgray"); abline(v=116627019/1e6, lwd=0.1, color="lightgray")
#       legend("topright", horiz=T, bty="n", legend=c("MA", "BA","Rhdf2"), col=c(colMul, colMrg, "orange"), pch=c(18,1,15), cex=0.87, bg="white")
         legend("topright", horiz=T, bty="n", legend=c("Clvs1", "Asph", "Gdf6" ), col=c("orange", "#FF6666", "#996633"), pch=c(15,15, 15), cex=0.77, bg="white", box.col="white")
...
#        rect(94612757/1e6,0.5,94658872/1e6,1.5, col="orange", border="orange", bty="n")#chd2
        ...
        rect(97203662/1e6,0.5,97297917/1e6,1.5, col="#6699CC", border="#6699CC", bty="n")#chd2
	rect(97158777/1e6,0.5,97177299/1e6,1.5, col="#9999FF", border="#9999FF", bty="n")#chd2
        rect(98013527/1e6,0.5,98150361/1e6,1.5, col="#CC99FF", border="#CC99FF", bty="n")#chd2
#	rect(98013527/1e6,0.5,98150361/1e6,1.5, col="#CC99FF", border="#CC99FF", bty="n")#chd2

#       abline(v=116598165/1e6, lwd=0.1, color="lightgray"); abline(v=116627019/1e6, lwd=0.1, color="lightgray")
#       legend("topright", horiz=T, bty="n", legend=c("MA", "BA","Rhdf2"), col=c(colMul, colMrg, "orange"), pch=c(18,1,15), cex=0.87, bg="white")
         legend("topright", horiz=T, bty="n", legend=c("Hfe2", "Bcl9", "Acp6", "Notch2" ), col=c("#FF0000","#6699CC", "#9999FF", "#CC99FF"), pch=c(15,15, 15, 15), cex=0.77, bg="white", box.col="white")
